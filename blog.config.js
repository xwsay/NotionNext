...
const BLOG = {
  API_BASE_URL: process.env.API_BASE_URL || 'https://common-kettle-af7.notion.site/api/v3', // API默认请求地址,可以配置成自己的地址例如：https://[xxxxx].notion.site/api/v3
  ...
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://xwsay.dpdns.org', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客', // 网站关键词 英文逗号隔开
  BLOG_FAVICON: process.env.NEXT_PUBLIC_FAVICON || 'https://img.xwsay.com/Piclist/20260329191023808.ico', // blog favicon 配置, 默认使用 /public/favicon.ico，支持在线图片，如 https://img.imesong.com/favicon.png
